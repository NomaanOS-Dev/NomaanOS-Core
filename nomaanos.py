...
from src.sovereign_license import SovereignLicenseManager
...
def print_help():
    ...
    print("  license     - Issue master sovereign institutional license watermark")
...
def main():
    ...
    if cmd == "license":
        ...
        print(json.dumps(lm.issue_license(), indent=2))
